...
**IMPORTANT: `html=1` is REQUIRED in the style of every cell that uses HTML in its `value` attribute (e.g., `&lt;b&gt;`, `&lt;br&gt;`, `&lt;font&gt;`).** Without `html=1`, HTML tags are rendered as literal text. Always include `html=1;` in the style string.
...
|----------|--------|---------|
| `html=1` | 0 or 1 | **Required** for HTML rendering in value (`<b>`, `<br>`, `<font>`, etc.) |
